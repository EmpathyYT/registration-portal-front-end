    ...
    return (
        <div className="mb-4">
            <div className="d-flex align-items-center gap-2 mb-3">
                ...
                <h6 className="fw-bold mb-0 menu-text section-label">Pending Invitations</h6>
                {invitations.length > 0 && (
                    <span className={`fw-bolder rounded-pill d-flex align-items-center gap-1 badge-pending ${invitations.length > 1 ? 'pulse' : ''}`}>
            ...
            {invitations.length === 0 ? (
                ...
                <div className="card border-0 bg-white rounded-4 shadow-sm p-3 d-flex flex-column flex-md-row align-items-md-center justify-content-between interactive-card fade-up card-border-brand">
                    <div className="d-flex align-items-center mb-3 mb-md-0">
                        ...
                        <div>
                            ...
                            <div className="d-flex align-items-center gap-2 mt-1 flex-wrap">
                                <span className="text-muted small">ID: {active.sender_university_id}</span>
                                <span className="text-muted small">·</span>
                                <span className="text-muted small">{new Date(active.created_at).toLocaleDateString()}</span>
                                {hasMultiple && (
